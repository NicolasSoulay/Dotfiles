...
globalkeys = gears.table.join(
	...
	end, { description = "open your mail client", group = "launcher" }),
	...
	awful.key({ modkey }, "p", function()
		awful.util.spawn(terminal .. " -e ncspot")
	end, { description = "open Ncspot", group = "launcher" })
)
