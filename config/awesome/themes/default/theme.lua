...
theme.bg_focus = os.getenv("BASE16_03") or "#505050"
theme.bg_urgent = os.getenv("BASE16_08") or "#ff0000"
theme.bg_minimize = os.getenv("BASE16_04") or "#444444"
theme.bg_systray = theme.bg_normal

theme.fg_normal = os.getenv("BASE16_07") or "#ddc7a1"
theme.fg_focus = os.getenv("BASE16_07") or "#d4be98"
theme.fg_urgent = os.getenv("BASE16_07") or "#d4be98"
theme.fg_minimize = os.getenv("BASE16_07") or "#d4be98"

theme.border_normal = os.getenv("BASE16_00") or "#282828"
theme.border_focus = os.getenv("BASE16_02") or "#C7C7B6"
...
theme.awesome_icon = themes_path .. "default/debian.png"
